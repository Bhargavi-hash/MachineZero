...
class HiddenOracle:
    ...
    def __init__(self, cpu: AlienCPU):
        self.__cpu = cpu

    @property
    def word_bits(self) -> int:
        return self.__cpu.spec.word_bits

    @property
    def num_registers(self) -> int:
        return self.__cpu.spec.num_registers

    @property
    def valid_opcodes(self) -> tuple[int, ...]:
        return tuple(x.opcode for x in self.__cpu.spec.opcodes)
